#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""2026-09-26 晚间 每日更新：2 篇新文章（六语：zh-Hant 根 / en / ja / ko / fr / es）
- 辅料刀模、印版与版辊归属指南：版费、保管与换厂转移
- 辅料外观验收的界限样品指南：缺陷判定口径怎么定
（主题池 30 个选题均已上线，本次为采购/质检运营方向扩展新选题，已核对 blog/ 与 sitemap 无重复）

用法: <python> daily_gen_20260926_evening.py
"""
...
BUST_OLD, BUST_NEW = "112", "113"
LANGS = ["en", "ja", "ko", "fr", "es"]

from daily_meta_20260926_evening import ARTICLES
