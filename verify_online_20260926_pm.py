...
3) curl 线上 js/main.js → BUST_VERSION = 112。
"""
...
UDD = os.path.join(TMP, "chrome_pm_20260926")
os.chdir(TMP)

SLUGS = ["trim-third-party-testing-guide.html", "sample-room-trims-checklist.html"]
LANGS = ["zh", "en", "ja", "ko", "fr", "es"]
BASE = "https://taigetag.com"
V = "112"

EXPECT = {
    ("trim-third-party-testing-guide.html", "zh"): "服裝輔料第三方檢測",
    ("trim-third-party-testing-guide.html", "en"): "Third-Party Testing",
    ("trim-third-party-testing-guide.html", "ja"): "第三者試験",
    ("trim-third-party-testing-guide.html", "ko"): "제3자 시험",
    ("trim-third-party-testing-guide.html", "fr"): "laboratoire tiers",
    ("trim-third-party-testing-guide.html", "es"): "laboratorio externo",
    ("sample-room-trims-checklist.html", "zh"): "樣衣間與打版房",
    ("sample-room-trims-checklist.html", "en"): "Sample Room Trim Checklist",
    ("sample-room-trims-checklist.html", "ja"): "サンプル室",
    ("sample-room-trims-checklist.html", "ko"): "샘플실",
    ("sample-room-trims-checklist.html", "fr"): "atelier d'échantillons",
    ("sample-room-trims-checklist.html", "es"): "sala de muestras",
}
...
sp = os.path.join(TMP, "sitemap_pm_20260926.xml")
sm = ""
...
for slug in SLUGS:
    for lang in LANGS:
        out = "dom_pm_20260926_%s_%s.html" % (lang, slug.replace(".html", ""))
...
mj = os.path.join(TMP, "main_pm_20260926.js")
