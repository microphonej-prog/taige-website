#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""2026-09-26 下午 每日更新：2 篇新文章（六语：zh-Hant 根 / en / ja / ko / fr / es）
- 服装辅料第三方检测送检指南：测试项目、样品量与报告解读
- 样衣间与打版房辅料常备清单：小批量出样不缺料
（主题池 30 个选题均已上线，本次为工艺/运营扩展新选题，已核对 blog/ 与 sitemap 无重复）

用法: <python> daily_gen_20260926_pm.py
"""
...
BUST_OLD, BUST_NEW = "111", "112"
LANGS = ["en", "ja", "ko", "fr", "es"]

from daily_meta_20260926_pm import ARTICLES
