#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""二次微调 description 长度，使其落在规范区间（中文 <=120 字、英文 150-160 字符）。"""
...
FIX = {
    "blog/clothing-label-compliance-saudi-arabia.html": dict(
        zh="沙特阿拉伯服装标签合规指南：纺织产品技术法规要求标签用阿拉伯语标注纤维成分、洗护说明、原产地与责任方，清关需 SASO 的 SABER 符合性证书。讲清七项必标信息、阿拉伯语排版要点、洗护符号对齐与打样核对清单。来自东莞泰阁包装。",
    ...
    "blog/clothing-label-compliance-turkey.html": dict(
        ...
        en="Turkey clothing label rules: Turkish-language composition, care, origin and the responsible party, rules modelled on EU 1007/2011 and TAREKS import inspections.",
    ),
}
