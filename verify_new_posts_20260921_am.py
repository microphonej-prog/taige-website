#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""校验 2026-09-21 上午新增的 2 篇六语文章：正文字段完整性、引号畸形、JSON-LD、
生成页残留、hreflang/canonical、sitemap、列表页卡片。"""
import re, json, os, sys
from html.parser import HTMLParser

NEW = ["blog/hanger-bag-guide.html", "blog/shrink-film-packaging-guide.html"]
...
for f in NEW:
    ...
    for lang in LANGS:
        ...
        print("  %-40s residue=%d 正文汉字=%d desc=%d字 hreflang=%d canonical=%s %s"
...
for f in NEW:
    ...
    print("  %-40s lastmod=%s" % (slug, z.group(1) if z else "缺失"))
